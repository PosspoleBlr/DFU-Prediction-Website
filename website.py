...
# Generate synthetic dataset and save CSV
np.random.seed(42)
n_samples = 1000
...
print("Synthetic dataset saved to 'synthetic_diabetic_foot_ulcer_data_new.csv'")
            ...
            <div class="col-lg-5 col-md-7 d-flex justify-content-center">
                <div class="form-container">
                    <form method="POST" action="/">
                        ...
                        {% endfor %}
                        <div class="mb-3">
                            <label for="pressure" class="form-label">Foot Pressure Sensor Value</label>
                            <input type="range" class="form-range outlined-range" id="pressure" name="pressure" min="0" max="150" value="{{ request.form.pressure or 50 }}" oninput="this.nextElementSibling.value = this.value" />
                            <output>{{ request.form.pressure or 50 }}</output>
                        </div>
...
def index():
    ...
    return render_template_string(HTML_TEMPLATE, prediction=prediction, probability=probability, request=request)
